    ...
    def test_MACHO(self):
        ...
        if arch == lief.ARCHITECTURES.X86:
            self.assertEqual(
                ...
                (
                    1,
                    f'{executable}: failed NOUNDEFS LAZY_BINDINGS Canary PIE NX CONTROL_FLOW',
                ),
            )
            ...
            self.assertEqual(
                ...
                (
                    1,
                    f'{executable}: failed NOUNDEFS LAZY_BINDINGS PIE NX CONTROL_FLOW',
                ),
            )
            ...
            self.assertEqual(
                ...
                (
                    1,
                    f'{executable}: failed NOUNDEFS LAZY_BINDINGS PIE CONTROL_FLOW',
                ),
            )
